...
{
    [SPECIES_AZURILL - SPECIES_AZURILL] = {.item = ITEM_SEA_INCENSE, .baseSpecies = SPECIES_MARILL},
    ...
    [SPECIES_MANTYKE - SPECIES_AZURILL] = {.item = ITEM_WAVE_INCENSE, .baseSpecies = SPECIES_MANTINE},
