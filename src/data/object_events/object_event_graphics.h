...
const u16 gFieldEffectPal_PokeRadarSparkle[] = INCBIN_U16("graphics/field_effects/palettes/poke_radar_sparkle.gbapal");
const u32 gFieldEffectObjectPic_PokeRadarSparkle[] = INCBIN_U32("graphics/field_effects/pics/poke_radar_sparkle.4bpp");
