...
{
    TRAINER_BACK_SPRITE(BRENDAN, gTrainerBackPic_Brendan, 0x34D0),
    TRAINER_BACK_SPRITE(MAY, gTrainerBackPic_May, 0x34D0),
    TRAINER_BACK_SPRITE(RED, gTrainerBackPic_Red, 0x4150),
    TRAINER_BACK_SPRITE(LEAF, gTrainerBackPic_Leaf, 0x4150),
    TRAINER_BACK_SPRITE(RUBY_SAPPHIRE_BRENDAN, gTrainerBackPic_RubySapphireBrendan, 0x34D0),
    TRAINER_BACK_SPRITE(RUBY_SAPPHIRE_MAY, gTrainerBackPic_RubySapphireMay, 0x34D0),
    TRAINER_BACK_SPRITE(WALLY, gTrainerBackPic_Wally, 0x34D0),
    TRAINER_BACK_SPRITE(STEVEN, gTrainerBackPic_Steven, 0x34D0),
};
