...
{
    TRAINER_SPRITE(HIKER, gTrainerFrontPic_Hiker, 0xC80),
    TRAINER_SPRITE(AQUA_GRUNT_M, gTrainerFrontPic_AquaGruntM, 0xC80),
    TRAINER_SPRITE(POKEMON_BREEDER_F, gTrainerFrontPic_PokemonBreederF, 0xC80),
    TRAINER_SPRITE(COOLTRAINER_M, gTrainerFrontPic_CoolTrainerM, 0xC80),
    TRAINER_SPRITE(BIRD_KEEPER, gTrainerFrontPic_BirdKeeper, 0xC80),
    TRAINER_SPRITE(COLLECTOR, gTrainerFrontPic_Collector, 0xC80),
    TRAINER_SPRITE(AQUA_GRUNT_F, gTrainerFrontPic_AquaGruntF, 0xC80),
    TRAINER_SPRITE(SWIMMER_M, gTrainerFrontPic_SwimmerM, 0xC80),
    TRAINER_SPRITE(MAGMA_GRUNT_M, gTrainerFrontPic_MagmaGruntM, 0xC80),
    TRAINER_SPRITE(EXPERT_M, gTrainerFrontPic_ExpertM, 0xC80),
    TRAINER_SPRITE(AQUA_ADMIN_M, gTrainerFrontPic_AquaAdminM, 0xC80),
    TRAINER_SPRITE(BLACK_BELT, gTrainerFrontPic_BlackBelt, 0xC80),
    TRAINER_SPRITE(AQUA_ADMIN_F, gTrainerFrontPic_AquaAdminF, 0xC80),
    TRAINER_SPRITE(AQUA_LEADER_ARCHIE, gTrainerFrontPic_AquaLeaderArchie, 0xC80),
    TRAINER_SPRITE(HEX_MANIAC, gTrainerFrontPic_HexManiac, 0xC80),
    TRAINER_SPRITE(AROMA_LADY, gTrainerFrontPic_AromaLady, 0xC80),
    TRAINER_SPRITE(RUIN_MANIAC, gTrainerFrontPic_RuinManiac, 0xC80),
    TRAINER_SPRITE(INTERVIEWER, gTrainerFrontPic_Interviewer, 0xC80),
    TRAINER_SPRITE(TUBER_F, gTrainerFrontPic_TuberF, 0xC80),
    TRAINER_SPRITE(TUBER_M, gTrainerFrontPic_TuberM, 0xC80),
    TRAINER_SPRITE(COOLTRAINER_F, gTrainerFrontPic_CoolTrainerF, 0xC80),
    TRAINER_SPRITE(LADY, gTrainerFrontPic_Lady, 0xC80),
    TRAINER_SPRITE(BEAUTY, gTrainerFrontPic_Beauty, 0xC80),
    TRAINER_SPRITE(RICH_BOY, gTrainerFrontPic_RichBoy, 0xC80),
    TRAINER_SPRITE(EXPERT_F, gTrainerFrontPic_ExpertF, 0xC80),
    TRAINER_SPRITE(POKEMANIAC, gTrainerFrontPic_Pokemaniac, 0xC80),
    TRAINER_SPRITE(MAGMA_GRUNT_F, gTrainerFrontPic_MagmaGruntF, 0xC80),
    TRAINER_SPRITE(GUITARIST, gTrainerFrontPic_Guitarist, 0xC80),
    TRAINER_SPRITE(KINDLER, gTrainerFrontPic_Kindler, 0xC80),
    TRAINER_SPRITE(CAMPER, gTrainerFrontPic_Camper, 0xC80),
    TRAINER_SPRITE(PICNICKER, gTrainerFrontPic_Picnicker, 0xC80),
    TRAINER_SPRITE(BUG_MANIAC, gTrainerFrontPic_BugManiac, 0xC80),
    TRAINER_SPRITE(POKEMON_BREEDER_M, gTrainerFrontPic_PokemonBreederM, 0xC80),
    TRAINER_SPRITE(PSYCHIC_M, gTrainerFrontPic_PsychicM, 0xC80),
    TRAINER_SPRITE(PSYCHIC_F, gTrainerFrontPic_PsychicF, 0xC80),
    TRAINER_SPRITE(GENTLEMAN, gTrainerFrontPic_Gentleman, 0xC80),
    TRAINER_SPRITE(ELITE_FOUR_SIDNEY, gTrainerFrontPic_EliteFourSidney, 0xC80),
    TRAINER_SPRITE(ELITE_FOUR_PHOEBE, gTrainerFrontPic_EliteFourPhoebe, 0xC80),
    TRAINER_SPRITE(ELITE_FOUR_GLACIA, gTrainerFrontPic_EliteFourGlacia, 0xC80),
    TRAINER_SPRITE(ELITE_FOUR_DRAKE, gTrainerFrontPic_EliteFourDrake, 0xC80),
    TRAINER_SPRITE(LEADER_ROXANNE, gTrainerFrontPic_LeaderRoxanne, 0xC80),
    TRAINER_SPRITE(LEADER_BRAWLY, gTrainerFrontPic_LeaderBrawly, 0xC80),
    TRAINER_SPRITE(LEADER_WATTSON, gTrainerFrontPic_LeaderWattson, 0xC80),
    TRAINER_SPRITE(LEADER_FLANNERY, gTrainerFrontPic_LeaderFlannery, 0xC80),
    TRAINER_SPRITE(LEADER_NORMAN, gTrainerFrontPic_LeaderNorman, 0xC80),
    TRAINER_SPRITE(LEADER_WINONA, gTrainerFrontPic_LeaderWinona, 0xC80),
    TRAINER_SPRITE(LEADER_TATE_AND_LIZA, gTrainerFrontPic_LeaderTateAndLiza, 0xC80),
    TRAINER_SPRITE(LEADER_JUAN, gTrainerFrontPic_LeaderJuan, 0xC80),
    TRAINER_SPRITE(SCHOOL_KID_M, gTrainerFrontPic_SchoolKidM, 0xC80),
    TRAINER_SPRITE(SCHOOL_KID_F, gTrainerFrontPic_SchoolKidF, 0xC80),
    TRAINER_SPRITE(SR_AND_JR, gTrainerFrontPic_SrAndJr, 0x1900),
    TRAINER_SPRITE(POKEFAN_M, gTrainerFrontPic_PokefanM, 0x1900),
    TRAINER_SPRITE(POKEFAN_F, gTrainerFrontPic_PokefanF, 0xC80),
    TRAINER_SPRITE(YOUNGSTER, gTrainerFrontPic_Youngster, 0xC80),
    TRAINER_SPRITE(CHAMPION_WALLACE, gTrainerFrontPic_ChampionWallace, 0x1900),
    TRAINER_SPRITE(FISHERMAN, gTrainerFrontPic_Fisherman, 0xC80),
    TRAINER_SPRITE(CYCLING_TRIATHLETE_M, gTrainerFrontPic_CyclingTriathleteM, 0x1900),
    TRAINER_SPRITE(CYCLING_TRIATHLETE_F, gTrainerFrontPic_CyclingTriathleteF, 0xC80),
    TRAINER_SPRITE(RUNNING_TRIATHLETE_M, gTrainerFrontPic_RunningTriathleteM, 0xC80),
    TRAINER_SPRITE(RUNNING_TRIATHLETE_F, gTrainerFrontPic_RunningTriathleteF, 0xC80),
    TRAINER_SPRITE(SWIMMING_TRIATHLETE_M, gTrainerFrontPic_SwimmingTriathleteM, 0xC80),
    TRAINER_SPRITE(SWIMMING_TRIATHLETE_F, gTrainerFrontPic_SwimmingTriathleteF, 0xC80),
    TRAINER_SPRITE(DRAGON_TAMER, gTrainerFrontPic_DragonTamer, 0xC80),
    TRAINER_SPRITE(NINJA_BOY, gTrainerFrontPic_NinjaBoy, 0xC80),
    TRAINER_SPRITE(BATTLE_GIRL, gTrainerFrontPic_BattleGirl, 0x1900),
    TRAINER_SPRITE(PARASOL_LADY, gTrainerFrontPic_ParasolLady, 0xC80),
    TRAINER_SPRITE(SWIMMER_F, gTrainerFrontPic_SwimmerF, 0xC80),
    TRAINER_SPRITE(TWINS, gTrainerFrontPic_Twins, 0xC80),
    TRAINER_SPRITE(SAILOR, gTrainerFrontPic_Sailor, 0xC80),
    TRAINER_SPRITE(MAGMA_ADMIN, gTrainerFrontPic_MagmaAdmin, 0xC80),
    TRAINER_SPRITE(WALLY, gTrainerFrontPic_Wally, 0xC80),
    TRAINER_SPRITE(BRENDAN, gTrainerFrontPic_Brendan, 0xC80),
    TRAINER_SPRITE(MAY, gTrainerFrontPic_May, 0xC80),
    TRAINER_SPRITE(BUG_CATCHER, gTrainerFrontPic_BugCatcher, 0xC80),
    TRAINER_SPRITE(POKEMON_RANGER_M, gTrainerFrontPic_PokemonRangerM, 0xC80),
    TRAINER_SPRITE(POKEMON_RANGER_F, gTrainerFrontPic_PokemonRangerF, 0xC80),
    TRAINER_SPRITE(MAGMA_LEADER_MAXIE, gTrainerFrontPic_MagmaLeaderMaxie, 0xC80),
    TRAINER_SPRITE(LASS, gTrainerFrontPic_Lass, 0xC80),
    TRAINER_SPRITE(YOUNG_COUPLE, gTrainerFrontPic_YoungCouple, 0xC80),
    TRAINER_SPRITE(OLD_COUPLE, gTrainerFrontPic_OldCouple, 0xC80),
    TRAINER_SPRITE(SIS_AND_BRO, gTrainerFrontPic_SisAndBro, 0xC80),
    TRAINER_SPRITE(STEVEN, gTrainerFrontPic_Steven, 0xC80),
    TRAINER_SPRITE(SALON_MAIDEN_ANABEL, gTrainerFrontPic_SalonMaidenAnabel, 0xC80),
    TRAINER_SPRITE(DOME_ACE_TUCKER, gTrainerFrontPic_DomeAceTucker, 0xC80),
    TRAINER_SPRITE(PALACE_MAVEN_SPENSER, gTrainerFrontPic_PalaceMavenSpenser, 0xC80),
    TRAINER_SPRITE(ARENA_TYCOON_GRETA, gTrainerFrontPic_ArenaTycoonGreta, 0x1900),
    TRAINER_SPRITE(FACTORY_HEAD_NOLAND, gTrainerFrontPic_FactoryHeadNoland, 0xC80),
    TRAINER_SPRITE(PIKE_QUEEN_LUCY, gTrainerFrontPic_PikeQueenLucy, 0xC80),
    TRAINER_SPRITE(PYRAMID_KING_BRANDON, gTrainerFrontPic_PyramidKingBrandon, 0xC80),
    TRAINER_SPRITE(RED, gTrainerFrontPic_Red, 0xC80),
    TRAINER_SPRITE(LEAF, gTrainerFrontPic_Leaf, 0xC80),
    TRAINER_SPRITE(RS_BRENDAN, gTrainerFrontPic_RubySapphireBrendan, 0xC80),
    TRAINER_SPRITE(RS_MAY, gTrainerFrontPic_RubySapphireMay, 0xC80),
};
