...
{
    TRAINER_SPRITE(HIKER, gTrainerFrontPic_Hiker, MON_PIC_SIZE),
    TRAINER_SPRITE(AQUA_GRUNT_M, gTrainerFrontPic_AquaGruntM, MON_PIC_SIZE),
    TRAINER_SPRITE(POKEMON_BREEDER_F, gTrainerFrontPic_PokemonBreederF, MON_PIC_SIZE),
    TRAINER_SPRITE(COOLTRAINER_M, gTrainerFrontPic_CoolTrainerM, MON_PIC_SIZE),
    TRAINER_SPRITE(BIRD_KEEPER, gTrainerFrontPic_BirdKeeper, MON_PIC_SIZE),
    TRAINER_SPRITE(COLLECTOR, gTrainerFrontPic_Collector, MON_PIC_SIZE),
    TRAINER_SPRITE(AQUA_GRUNT_F, gTrainerFrontPic_AquaGruntF, MON_PIC_SIZE),
    TRAINER_SPRITE(SWIMMER_M, gTrainerFrontPic_SwimmerM, MON_PIC_SIZE),
    TRAINER_SPRITE(MAGMA_GRUNT_M, gTrainerFrontPic_MagmaGruntM, MON_PIC_SIZE),
    TRAINER_SPRITE(EXPERT_M, gTrainerFrontPic_ExpertM, MON_PIC_SIZE),
    TRAINER_SPRITE(AQUA_ADMIN_M, gTrainerFrontPic_AquaAdminM, MON_PIC_SIZE),
    TRAINER_SPRITE(BLACK_BELT, gTrainerFrontPic_BlackBelt, MON_PIC_SIZE),
    TRAINER_SPRITE(AQUA_ADMIN_F, gTrainerFrontPic_AquaAdminF, MON_PIC_SIZE),
    TRAINER_SPRITE(AQUA_LEADER_ARCHIE, gTrainerFrontPic_AquaLeaderArchie, MON_PIC_SIZE),
    TRAINER_SPRITE(HEX_MANIAC, gTrainerFrontPic_HexManiac, MON_PIC_SIZE),
    TRAINER_SPRITE(AROMA_LADY, gTrainerFrontPic_AromaLady, MON_PIC_SIZE),
    TRAINER_SPRITE(RUIN_MANIAC, gTrainerFrontPic_RuinManiac, MON_PIC_SIZE),
    TRAINER_SPRITE(INTERVIEWER, gTrainerFrontPic_Interviewer, MON_PIC_SIZE),
    TRAINER_SPRITE(TUBER_F, gTrainerFrontPic_TuberF, MON_PIC_SIZE),
    TRAINER_SPRITE(TUBER_M, gTrainerFrontPic_TuberM, MON_PIC_SIZE),
    TRAINER_SPRITE(COOLTRAINER_F, gTrainerFrontPic_CoolTrainerF, MON_PIC_SIZE),
    TRAINER_SPRITE(LADY, gTrainerFrontPic_Lady, MON_PIC_SIZE),
    TRAINER_SPRITE(BEAUTY, gTrainerFrontPic_Beauty, MON_PIC_SIZE),
    TRAINER_SPRITE(RICH_BOY, gTrainerFrontPic_RichBoy, MON_PIC_SIZE),
    TRAINER_SPRITE(EXPERT_F, gTrainerFrontPic_ExpertF, MON_PIC_SIZE),
    TRAINER_SPRITE(POKEMANIAC, gTrainerFrontPic_Pokemaniac, MON_PIC_SIZE),
    TRAINER_SPRITE(MAGMA_GRUNT_F, gTrainerFrontPic_MagmaGruntF, MON_PIC_SIZE),
    TRAINER_SPRITE(GUITARIST, gTrainerFrontPic_Guitarist, MON_PIC_SIZE),
    TRAINER_SPRITE(KINDLER, gTrainerFrontPic_Kindler, MON_PIC_SIZE),
    TRAINER_SPRITE(CAMPER, gTrainerFrontPic_Camper, MON_PIC_SIZE),
    TRAINER_SPRITE(PICNICKER, gTrainerFrontPic_Picnicker, MON_PIC_SIZE),
    TRAINER_SPRITE(BUG_MANIAC, gTrainerFrontPic_BugManiac, MON_PIC_SIZE),
    TRAINER_SPRITE(POKEMON_BREEDER_M, gTrainerFrontPic_PokemonBreederM, MON_PIC_SIZE),
    TRAINER_SPRITE(PSYCHIC_M, gTrainerFrontPic_PsychicM, MON_PIC_SIZE),
    TRAINER_SPRITE(PSYCHIC_F, gTrainerFrontPic_PsychicF, MON_PIC_SIZE),
    TRAINER_SPRITE(GENTLEMAN, gTrainerFrontPic_Gentleman, MON_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_SIDNEY, gTrainerFrontPic_EliteFourSidney, MON_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_PHOEBE, gTrainerFrontPic_EliteFourPhoebe, MON_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_GLACIA, gTrainerFrontPic_EliteFourGlacia, MON_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_DRAKE, gTrainerFrontPic_EliteFourDrake, MON_PIC_SIZE),
    TRAINER_SPRITE(LEADER_ROXANNE, gTrainerFrontPic_LeaderRoxanne, MON_PIC_SIZE),
    TRAINER_SPRITE(LEADER_BRAWLY, gTrainerFrontPic_LeaderBrawly, MON_PIC_SIZE),
    TRAINER_SPRITE(LEADER_WATTSON, gTrainerFrontPic_LeaderWattson, MON_PIC_SIZE),
    TRAINER_SPRITE(LEADER_FLANNERY, gTrainerFrontPic_LeaderFlannery, MON_PIC_SIZE),
    TRAINER_SPRITE(LEADER_NORMAN, gTrainerFrontPic_LeaderNorman, MON_PIC_SIZE),
    TRAINER_SPRITE(LEADER_WINONA, gTrainerFrontPic_LeaderWinona, MON_PIC_SIZE),
    TRAINER_SPRITE(LEADER_TATE_AND_LIZA, gTrainerFrontPic_LeaderTateAndLiza, MON_PIC_SIZE),
    TRAINER_SPRITE(LEADER_JUAN, gTrainerFrontPic_LeaderJuan, MON_PIC_SIZE),
    TRAINER_SPRITE(SCHOOL_KID_M, gTrainerFrontPic_SchoolKidM, MON_PIC_SIZE),
    TRAINER_SPRITE(SCHOOL_KID_F, gTrainerFrontPic_SchoolKidF, MON_PIC_SIZE),
    TRAINER_SPRITE(SR_AND_JR, gTrainerFrontPic_SrAndJr, (MON_PIC_SIZE * 2)),
    TRAINER_SPRITE(POKEFAN_M, gTrainerFrontPic_PokefanM, (MON_PIC_SIZE * 2)),
    TRAINER_SPRITE(POKEFAN_F, gTrainerFrontPic_PokefanF, MON_PIC_SIZE),
    TRAINER_SPRITE(YOUNGSTER, gTrainerFrontPic_Youngster, MON_PIC_SIZE),
    TRAINER_SPRITE(CHAMPION_WALLACE, gTrainerFrontPic_ChampionWallace, (MON_PIC_SIZE * 2)),
    TRAINER_SPRITE(FISHERMAN, gTrainerFrontPic_Fisherman, MON_PIC_SIZE),
    TRAINER_SPRITE(CYCLING_TRIATHLETE_M, gTrainerFrontPic_CyclingTriathleteM, (MON_PIC_SIZE * 2)),
    TRAINER_SPRITE(CYCLING_TRIATHLETE_F, gTrainerFrontPic_CyclingTriathleteF, MON_PIC_SIZE),
    TRAINER_SPRITE(RUNNING_TRIATHLETE_M, gTrainerFrontPic_RunningTriathleteM, MON_PIC_SIZE),
    TRAINER_SPRITE(RUNNING_TRIATHLETE_F, gTrainerFrontPic_RunningTriathleteF, MON_PIC_SIZE),
    TRAINER_SPRITE(SWIMMING_TRIATHLETE_M, gTrainerFrontPic_SwimmingTriathleteM, MON_PIC_SIZE),
    TRAINER_SPRITE(SWIMMING_TRIATHLETE_F, gTrainerFrontPic_SwimmingTriathleteF, MON_PIC_SIZE),
    TRAINER_SPRITE(DRAGON_TAMER, gTrainerFrontPic_DragonTamer, MON_PIC_SIZE),
    TRAINER_SPRITE(NINJA_BOY, gTrainerFrontPic_NinjaBoy, MON_PIC_SIZE),
    TRAINER_SPRITE(BATTLE_GIRL, gTrainerFrontPic_BattleGirl, (MON_PIC_SIZE * 2)),
    TRAINER_SPRITE(PARASOL_LADY, gTrainerFrontPic_ParasolLady, MON_PIC_SIZE),
    TRAINER_SPRITE(SWIMMER_F, gTrainerFrontPic_SwimmerF, MON_PIC_SIZE),
    TRAINER_SPRITE(TWINS, gTrainerFrontPic_Twins, MON_PIC_SIZE),
    TRAINER_SPRITE(SAILOR, gTrainerFrontPic_Sailor, MON_PIC_SIZE),
    TRAINER_SPRITE(MAGMA_ADMIN, gTrainerFrontPic_MagmaAdmin, MON_PIC_SIZE),
    TRAINER_SPRITE(WALLY, gTrainerFrontPic_Wally, MON_PIC_SIZE),
    TRAINER_SPRITE(BRENDAN, gTrainerFrontPic_Brendan, MON_PIC_SIZE),
    TRAINER_SPRITE(MAY, gTrainerFrontPic_May, MON_PIC_SIZE),
    TRAINER_SPRITE(BUG_CATCHER, gTrainerFrontPic_BugCatcher, MON_PIC_SIZE),
    TRAINER_SPRITE(POKEMON_RANGER_M, gTrainerFrontPic_PokemonRangerM, MON_PIC_SIZE),
    TRAINER_SPRITE(POKEMON_RANGER_F, gTrainerFrontPic_PokemonRangerF, MON_PIC_SIZE),
    TRAINER_SPRITE(MAGMA_LEADER_MAXIE, gTrainerFrontPic_MagmaLeaderMaxie, MON_PIC_SIZE),
    TRAINER_SPRITE(LASS, gTrainerFrontPic_Lass, MON_PIC_SIZE),
    TRAINER_SPRITE(YOUNG_COUPLE, gTrainerFrontPic_YoungCouple, MON_PIC_SIZE),
    TRAINER_SPRITE(OLD_COUPLE, gTrainerFrontPic_OldCouple, MON_PIC_SIZE),
    TRAINER_SPRITE(SIS_AND_BRO, gTrainerFrontPic_SisAndBro, MON_PIC_SIZE),
    TRAINER_SPRITE(STEVEN, gTrainerFrontPic_Steven, MON_PIC_SIZE),
    TRAINER_SPRITE(SALON_MAIDEN_ANABEL, gTrainerFrontPic_SalonMaidenAnabel, MON_PIC_SIZE),
    TRAINER_SPRITE(DOME_ACE_TUCKER, gTrainerFrontPic_DomeAceTucker, MON_PIC_SIZE),
    TRAINER_SPRITE(PALACE_MAVEN_SPENSER, gTrainerFrontPic_PalaceMavenSpenser, MON_PIC_SIZE),
    TRAINER_SPRITE(ARENA_TYCOON_GRETA, gTrainerFrontPic_ArenaTycoonGreta, (MON_PIC_SIZE * 2)),
    TRAINER_SPRITE(FACTORY_HEAD_NOLAND, gTrainerFrontPic_FactoryHeadNoland, MON_PIC_SIZE),
    TRAINER_SPRITE(PIKE_QUEEN_LUCY, gTrainerFrontPic_PikeQueenLucy, MON_PIC_SIZE),
    TRAINER_SPRITE(PYRAMID_KING_BRANDON, gTrainerFrontPic_PyramidKingBrandon, MON_PIC_SIZE),
    TRAINER_SPRITE(RED, gTrainerFrontPic_Red, MON_PIC_SIZE),
    TRAINER_SPRITE(LEAF, gTrainerFrontPic_Leaf, MON_PIC_SIZE),
    TRAINER_SPRITE(RS_BRENDAN, gTrainerFrontPic_RubySapphireBrendan, MON_PIC_SIZE),
    TRAINER_SPRITE(RS_MAY, gTrainerFrontPic_RubySapphireMay, MON_PIC_SIZE),
};
