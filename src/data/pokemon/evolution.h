const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_LICKITUNG]  = {{EVO_LEVEL_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
    [SPECIES_KOFFING]    = {{EVO_LEVEL, 35, SPECIES_WEEZING}},
    [SPECIES_RHYHORN]    = {{EVO_LEVEL, 42, SPECIES_RHYDON}},
    [SPECIES_RHYDON]     = {{EVO_LEVEL_ITEM, ITEM_PROTECTOR, SPECIES_RHYPERIOR}},
    [SPECIES_CHANSEY]    = {{EVO_FRIENDSHIP, 0, SPECIES_BLISSEY}},
    [SPECIES_TANGELA]    = {{EVO_LEVEL_MOVE, MOVE_ANCIENT_POWER, SPECIES_TANGROWTH}},
    ...
    [SPECIES_ELECTABUZZ] = {{EVO_LEVEL_ITEM, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]     = {{EVO_LEVEL_ITEM, ITEM_MAGMARIZER, SPECIES_MAGMORTAR}},
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            {EVO_PETALBURG_WOODS, 0, SPECIES_LEAFEON},
                            {EVO_SHOAL_CAVE, 0, SPECIES_GLACEON}},
    ...
    [SPECIES_AIPOM]      = {{EVO_LEVEL_MOVE, MOVE_DOUBLE_SLAP, SPECIES_AMBIPOM}},
    [SPECIES_SUNKERN]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNFLORA}},
    [SPECIES_YANMA]      = {{EVO_LEVEL_MOVE, MOVE_ANCIENT_POWER, SPECIES_YANMEGA}},
    ...
    [SPECIES_GLIGAR]     = {{EVO_LEVEL_ITEM_NIGHT, ITEM_RAZOR_FANG, SPECIES_GLISCOR}},
    ...
    [SPECIES_PILOSWINE]  = {{EVO_LEVEL_MOVE, MOVE_ANCIENT_POWER, SPECIES_MAMOSWINE}},
    ...
    [SPECIES_PORYGON2]   = {{EVO_LEVEL_ITEM, ITEM_DUBIOUS_DISC, SPECIES_PORYGONZ}},
    ...
    [SPECIES_DUSCLOPS]   = {{EVO_LEVEL_ITEM, ITEM_REAPER_CLOTH, SPECIES_DUSKNOIR}},
    ...
    [SPECIES_BONSLY]     = {{EVO_LEVEL_MOVE, MOVE_MIMIC, SPECIES_SUDOWOODO}},
    [SPECIES_BUDEW]      = {{EVO_FRIENDSHIP_DAY, 0, SPECIES_ROSELIA}},
    [SPECIES_CHINGLING]  = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_CHIMECHO}},
    [SPECIES_HAPPINY]    = {{EVO_LEVEL_ITEM_DAY, ITEM_OVAL_STONE, SPECIES_CHANSEY}},
