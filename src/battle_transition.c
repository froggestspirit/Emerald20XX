...
static void Mugshots_CreateOpponentPlayerSprites(struct Task *task)
{
    ...
    task->tOpponentSpriteId = CreateTrainerSprite(sMugshotsTrainerPicIDsTable[mugshotId],
                                                     ...
                                                     sMugshotsOpponentCoords[mugshotId][1] + 34,
                                                     0, gDecompressionBuffer);
    task->tPlayerSpriteId = CreateTrainerSprite(PlayerGenderToFrontTrainerPicId(gSaveBlock2Ptr->playerGender), DISPLAY_WIDTH + 32, 98, 0, gDecompressionBuffer);
