...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_AMBIPOM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_BONSLY] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_BUDEW] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_CHINGLING] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_DUSKNOIR] = BACK_ANIM_VERTICAL_STRETCH,
    ...
    [SPECIES_GLISCOR] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_HAPPINY] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_HONCHKROW] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_LEAFEON] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_LICKILICKY] = BACK_ANIM_GROW_1,
    [SPECIES_MAGMORTAR] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_MAGNEZONE] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_MAMOSWINE] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_MANTYKE] = BACK_ANIM_H_SLIDE,
    [SPECIES_MIME_JR] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MISMAGIUS] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_MUNCHLAX] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_PORYGONZ] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_PROBOPASS] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_RHYPERIOR] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_ROSERADE] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_TANGROWTH] = BACK_ANIM_GROW_1,
    [SPECIES_TOGEKISS] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_WEAVILE] = BACK_ANIM_H_SLIDE_QUICK,
