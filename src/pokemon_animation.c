...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_AMBIPOM]    = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_BONSLY]     = BACK_ANIM_V_SHAKE,
    [SPECIES_BUDEW]      = BACK_ANIM_V_SHAKE,
    [SPECIES_CHINGLING]  = BACK_ANIM_V_STRETCH,
    [SPECIES_DUSKNOIR]   = BACK_ANIM_V_STRETCH,
    [SPECIES_ELECTIVIRE] = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_FROSLASS]   = BACK_ANIM_H_SHAKE,
    ...
    [SPECIES_HAPPINY]    = BACK_ANIM_H_SHAKE,
    ...
    [SPECIES_MAGNEZONE]  = BACK_ANIM_V_STRETCH,
    [SPECIES_MAMOSWINE]  = BACK_ANIM_V_STRETCH,
    [SPECIES_MANTYKE]    = BACK_ANIM_H_SLIDE,
    [SPECIES_MIME_JR]    = BACK_ANIM_V_SHAKE,
    [SPECIES_MISMAGIUS]  = BACK_ANIM_SHRINK_GROW,
    [SPECIES_MUNCHLAX]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_PORYGONZ]   = BACK_ANIM_V_STRETCH,
    [SPECIES_PROBOPASS]  = BACK_ANIM_V_STRETCH,
    [SPECIES_RHYPERIOR]  = BACK_ANIM_V_STRETCH,
    ...
    [SPECIES_YANMEGA]    = BACK_ANIM_H_SHAKE,
};
