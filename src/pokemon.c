...
void CreateMonWithNature(struct Pokemon *mon, u16 species, u8 level, u8 fixedIV, u8 nature, bool8 forceShiny)
{
    ...
    if (forceShiny)
    {
        do
        {
            personality = GenerateShinyPersonality(T1_READ_32(gSaveBlock2Ptr->playerTrainerId));
        }
