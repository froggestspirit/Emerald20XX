...
#define YPOS_EXPALL       (MENUITEM_EXPALL * 16)
#define YPOS_QUICKLOAD    (MENUITEM_QUICKLOAD * 16)
#define YPOS_MUSICPLAYER  (MENUITEM_MUSICPLAYER * 16)
...
static u8   QuickLoad_ProcessInput(u8 selection);
static void QuickLoad_DrawChoices(u8 selection);
...
static const u8 *const sOptionMenuItemsNames[MENUITEM_COUNT] =
{
    ...
    //[MENUITEM_MUSICPLAYER] = gText_MusicPlayer,
...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].data[TD_EXPALL] = gSaveBlock2Ptr->optionsExpAll;
        gTasks[taskId].data[TD_QUICKLOAD] = gSaveBlock2Ptr->optionsQuickLoad;
...
static void Task_OptionMenuProcessInput(u8 taskId)
{
    ...
    else
    {
        ...
        case MENUITEM_EXPALL:
            previousOption = gTasks[taskId].data[TD_EXPALL];
            gTasks[taskId].data[TD_EXPALL] = Sound_ProcessInput(gTasks[taskId].data[TD_EXPALL]);

            if (previousOption != gTasks[taskId].data[TD_EXPALL])
                ExpAll_DrawChoices(gTasks[taskId].data[TD_EXPALL]);
            break;
        case MENUITEM_QUICKLOAD:
            previousOption = gTasks[taskId].data[TD_QUICKLOAD];
            gTasks[taskId].data[TD_QUICKLOAD] = Sound_ProcessInput(gTasks[taskId].data[TD_QUICKLOAD]);

            if (previousOption != gTasks[taskId].data[TD_QUICKLOAD])
                QuickLoad_DrawChoices(gTasks[taskId].data[TD_QUICKLOAD]);
            break;
        default:
            return;
        }
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsExpAll = gTasks[taskId].data[TD_EXPALL];
    gSaveBlock2Ptr->optionsQuickLoad = gTasks[taskId].data[TD_QUICKLOAD];
...
static void BattleScene_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_OptionOn, 104, YPOS_BATTLESCENE, styles[0]);
    DrawOptionMenuChoice(gText_OptionOff, GetStringRightAlignXOffset(1, gText_OptionOff, 198), YPOS_BATTLESCENE, styles[1]);
}
...
static void ExpAll_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_OptionOn, 104, YPOS_EXPALL, styles[0]);
    DrawOptionMenuChoice(gText_OptionOff, GetStringRightAlignXOffset(1, gText_OptionOff, 198), YPOS_EXPALL, styles[1]);
}
...
static void QuickLoad_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_OptionOn, 104, YPOS_QUICKLOAD, styles[0]);
    DrawOptionMenuChoice(gText_OptionOff, GetStringRightAlignXOffset(1, gText_OptionOff, 198), YPOS_QUICKLOAD, styles[1]);
}
